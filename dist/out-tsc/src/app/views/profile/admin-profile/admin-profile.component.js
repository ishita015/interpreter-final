...
var AdminProfileComponent = /** @class */ (function () {
    function AdminProfileComponent(validation, fb, toastr, router, service) {
    ...
    AdminProfileComponent.prototype.createForm = function () {
    ...
    AdminProfileComponent.prototype.patchValue = function () {
    ...
    AdminProfileComponent.prototype.CountryList = function () {
        var _this = this;
    ...
    AdminProfileComponent.prototype.onSingleFileChange = function (event) {
    ...
    AdminProfileComponent.prototype.admin_profile = function () {
        var _this = this;
