...
let BroadcastRequestComponent = /** @class */ (() => {
    let BroadcastRequestComponent = class BroadcastRequestComponent {
    ...
    BroadcastRequestComponent = __decorate([
        Component({
    ...
    return BroadcastRequestComponent;
})();
export { BroadcastRequestComponent };
//# sourceMappingURL=broadcast-request.component.js.map