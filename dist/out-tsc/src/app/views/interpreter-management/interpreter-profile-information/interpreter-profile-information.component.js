...
let InterpreterProfileInformationComponent = /** @class */ (() => {
    let InterpreterProfileInformationComponent = class InterpreterProfileInformationComponent {
        ...
        getAssignmentDetails() {
            this.service.get('getAssignmentDetails' + this.interId).subscribe((res) => {
            });
        }
        createItem() {
