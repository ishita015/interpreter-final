...
var InterpreterProfileInformationComponent = /** @class */ (function () {
    ...
    //banking code start
    InterpreterProfileInformationComponent.prototype.addBankInfo = function () {
    ...
    InterpreterProfileInformationComponent.prototype.selectRoutingNo = function (e) {
        var _this = this;
        this.service.getRoutingNumber(e).subscribe(function (res) {
            // console.log("api respone for routing no",res);
            _this.routingNo = res;
            console.log("api respone for routing no", _this.routingNo);
            _this.bankingRoutingForm.get('routing_number').patchValue(_this.routingNo.routing_number);
            _this.bankingRoutingForm.get('customer_name').patchValue(_this.routingNo.customer_name);
            _this.bankingRoutingForm.get('address').patchValue(_this.routingNo.address);
            // if (res['status'] == 1) {
            //   this.ass_Obj = res
            // }
            //  else {
