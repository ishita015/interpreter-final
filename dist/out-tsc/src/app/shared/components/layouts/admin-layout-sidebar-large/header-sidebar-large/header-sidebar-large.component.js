...
let HeaderSidebarLargeComponent = /** @class */ (() => {
    let HeaderSidebarLargeComponent = class HeaderSidebarLargeComponent {
        constructor(navService, searchService, router, auth) {
