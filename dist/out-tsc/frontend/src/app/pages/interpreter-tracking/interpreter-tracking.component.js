...
let InterpreterTrackingComponent = /** @class */ (() => {
    var _a, _b;
    let InterpreterTrackingComponent = class InterpreterTrackingComponent {
        constructor(router, service, validation, toastr, fb, route) {
            this.router = router;
