...
var commonDataBase = require('./Models/commonAdnan');
...
module.exports.clientDetail = async function(req, res) {
    try{
...
module.exports.getAllLOB = async function(req, res) {
        try {
            var result = await commonDataBase.selectAllWhere("master_lob", { status: 1 });
            return res.json({ status: true, msg: 'Data Found!', data: result });
        } catch (err) {
            return res.json({ status: false, data: '', msg: 'No Data Found!' });
        }
...
module.exports.getAllAssignmentTypes = async function(req, res) {
        try {
            var result = await commonDataBase.selectAllWhere("assignment_types", { status: 1, lob_id: req.params.id });
            return res.json({ status: true, msg: 'Data Found!', data: result });
        } catch (err) {
            return res.json({ status: false, data: '', msg: 'No Data Found!' });
        }
...
module.exports.getAllPlatforms = async function(req, res) {
        try {
            var result = await commonDataBase.selectAllWhere("master_platform", { status: 1 });
            return res.json({ status: true, msg: 'Data Found!', data: result });
        } catch (err) {
            return res.json({ status: false, data: '', msg: 'No Data Found!' });
        }
...
module.exports.getAllLanguages = async function(req, res) {
        try {
            var result = await commonDataBase.selectAllWhere("languages", { status: 1 });
            return res.json({ status: true, msg: 'Data Found!', data: result });
        } catch (err) {
            return res.json({ status: false, data: '', msg: 'No Data Found!' });
        }
...
module.exports.getDays = async function(req, res) {
        try {
            var result = await commonDataBase.selectAll("days");
            return res.json({ status: true, msg: 'Data Found!', data: result });
        } catch (err) {
            return res.json({ status: false, data: '', msg: 'No Data Found!' });
        }
...
module.exports.enterNewClientRequestBasicTab = async function(req, res) {
        try {
            ...
            var result = await commonDataBase.insert("request_information_services", ris);
            delete req.body.scheduler_id;
            delete req.body.email;
            delete req.body.client_id;
            req.body.ris_id = result.insertId;
            var result01 = await commonDataBase.insert("appointment_information_services", req.body);
...
module.exports.getLastRISEntry = async function(req, res) {
        try {
            var getCode = await commonDataBase.getCode();
            var result = await commonDataBase.getLastRISEntry();
            var data;
            if (result.length <= 0) {
...
module.exports.getAllBasicTabList = async function(req, res) {
        try {
            var result = await commonDataBase.getAllBasicTabList(req.params.id);
            return res.json({ status: true, msg: 'Data Found!', data: result });
        } catch (err) {
            return res.json({ status: false, data: '', msg: 'No data found!' });
        }
...
module.exports.getRequestDetails = async function(req, res) {
        try {
            var result = await commonDataBase.getRequestDetails(req.params.id);
...
module.exports.getRateSettingPlatforms = async function(req, res) {
    try {
        var result = await commonDataBase.getRateSettingPlatforms(req.params.id);
        return res.json({ status: true, msg: 'Data Found!', data: result });
    } catch (err) {
        return res.json({ status: false, data: '', msg: 'No data found!' });
    }
...
module.exports.getUsersRole = async function(req, res) {
        try {
            var result = await commonDataBase.selectAll("user_roles");
            return res.json({ status: true, msg: 'Data Found!', data: result });
        } catch (err) {
            return res.json({ status: false, data: '', msg: 'No data found!' });
        }
